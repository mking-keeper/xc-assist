...
import { runCommand, runCommandWithInput } from "../../shared/utils/command.js";
...
describe("runCommandWithInput", () => {
  ...
  it("should execute command with stdin input", async () => {
    const resultPromise = runCommandWithInput("cmd", ["arg"], "input data");
  ...
  it("should capture stderr", async () => {
    const resultPromise = runCommandWithInput("cmd", ["arg"], "input");
  ...
  it("should handle command timeout", async () => {
    const resultPromise = runCommandWithInput("slow", ["cmd"], "input", {
      timeout: 1000,
    });
  ...
  it("should handle command execution errors", async () => {
    const resultPromise = runCommandWithInput("nonexistent", ["cmd"], "input");
