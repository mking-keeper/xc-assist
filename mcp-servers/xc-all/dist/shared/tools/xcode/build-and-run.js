...
export const xcodeBuildAndRunDefinition = {
    ...
    description: "Build iOS app and immediately install and launch on simulator (rapid development workflow)",
    inputSchema: {
        type: "object",
        properties: {
            project_path: {
            ...
            destination: {
                type: "string",
                description: "Simulator destination. IMPORTANT: Must specify a simulator destination.\\n" +
                    "Recommended formats:\\n" +
