...
export const simulatorSetLocationDefinition = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            action: {
                ...
                description: "Action: 'set' for single location, 'clear' to reset, 'start' for waypoint route, 'list' for available scenarios",
            },
            latitude: {
                type: "number",
            ...
            waypoints: {
                type: "array",
                description: "Array of waypoints for 'start' action (simulates movement between points)",
                items: {
                    type: "object",
                    properties: {
...
export async function simulatorSetLocation(params) {
    try {
        ...
        switch (params.action) {
            case "set": {
                ...
                logger.info(`Setting location on ${deviceId}: ${params.latitude},${params.longitude}`);
        ...
        logger.error("Location operation failed", error);
        return {
            success: false,
            error: String(error),
            operation: "location",
