        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            switch (name) {
                ...
                case 'simulator_screenshot':
                    return { content: [{ type: 'text', text: JSON.stringify(await simulatorScreenshot(args)) }] };
                ...
                case 'simulator_get_app_container':
                    return { content: [{ type: 'text', text: JSON.stringify(await simulatorGetAppContainer(args)) }] };
                default:
